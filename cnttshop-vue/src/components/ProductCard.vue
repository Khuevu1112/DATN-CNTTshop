...
<template>
  <div
    ...
    style="
      cursor: pointer;
      background: linear-gradient(180deg, #0c2742, #0a2138);
  ...
  >
    ...
    >
      ...
      <div
        ...
        "
      >
        ★ <span style="color: #cfdceb; font-weight: 600">{{ ratingText }}</span
        ><span style="color: #6e87a6">({{ p.reviews }})</span>
      </div>
      <div
        style="
          margin-top: auto;
      ...
      >
        ...
        <button
          ...
          style="
            ...
            border: none;
            border-radius: 10px;
            background: color-mix(in srgb, var(--acc) 16%, #0c2742);
            color: var(--acc);
            font-size: 20px;
            line-height: 1;
            cursor: pointer;
