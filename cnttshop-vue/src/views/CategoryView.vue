...
const catTitle = computed(() =>
  state.cat === 'all'
    ? 'Tất cả sản phẩm'
    : catMeta[state.cat]?.vn || 'Sản phẩm',
);

const base = computed(() =>
  products.filter((p) => (state.cat === 'all' ? true : p.cat === state.cat)),
);
...
<template>
  <main style="max-width: 1800px; margin: 0 auto; padding: 24px 24px 70px">
    <div style="font-size: 12.5px; color: #7e98b6; margin-bottom: 14px">
      <span @click="actions.goHome" style="cursor: pointer">Trang chủ</span>
      <span style="color: #4a627e">/</span>
      <span style="color: #cfdceb">{{ catTitle }}</span>
    </div>
    <div
      style="
        display: flex;
    ...
    >
      ...
      <span style="font-size: 13px; color: #7e98b6"
    ...
    >
          ...
          <div style="display: flex; flex-direction: column; gap: 9px">
            ...
            >
              ...
              >
                <span
                  v-if="b.active"
                  style="color: #04121f; font-size: 12px; font-weight: 700"
                  >✓</span
                >
              </span>
      ...
      <div>
        ...
        >
          ...
          <div style="font-size: 15px; color: #cfdceb">
