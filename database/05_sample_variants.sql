...
IF NOT EXISTS (SELECT 1 FROM PRODUCT WHERE slug = 'laptop-lenovo-loq-15')
...
IF NOT EXISTS (SELECT 1 FROM PRODUCT_OPTION po JOIN PRODUCT p ON po.product_id = p.id WHERE p.slug = 'laptop-lenovo-loq-15')
BEGIN
