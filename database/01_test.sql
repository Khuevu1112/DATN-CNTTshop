...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'ShopDB_SyncTest')
BEGIN
    ALTER DATABASE ShopDB_SyncTest
    SET SINGLE_USER
    WITH ROLLBACK IMMEDIATE;

    DROP DATABASE ShopDB_SyncTest;
END
GO

-- Tạo database mới
CREATE DATABASE ShopDB_SyncTest
...
PRINT N'✅ Database ShopDB_SyncTest đã tạo thành công!';
GO
