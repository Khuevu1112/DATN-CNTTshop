...
export const CATS = {
  laptop: { label: 'Laptop', hue: 210 },
  'pc-may-tinh-ban': { label: 'PC bàn', hue: 265 },
  'linh-kien': { label: 'Linh kiện', hue: 150 },
  'man-hinh': { label: 'Màn hình', hue: 190 },
  'ngoai-vi': { label: 'Ngoại vi', hue: 32 },
  'phu-kien': { label: 'Phụ kiện', hue: 330 },
};
export const STATUS = {
...
const RAW_ORDERS = [
  ...
  [
    ...
    'shipped',
    '15/06 08:10',
    'RTX 4060 + RAM Corsair',
  ],
  [
    'DH240613',
    'Lê Hoàng Cường',
    'cuong.le@outlook.com',
    62900000,
    'processing',
    '14/06 21:30',
    'PC CNTT Apex RTX 4080S',
  ],
  [
    'DH240612',
    'Phạm Minh Dũng',
...
export const ORDERS = RAW_ORDERS.map((r, i) => {
  ...
  return {
    ...
    st,
    stLabel: STATUS[st].label,
    stColor: STATUS[st].color,
    stBg: stBgOf(STATUS[st].color),
    date,
    item,
    init: initials(customer),
  };
});
...
const RM = {
  ...
  staff: { label: 'Nhân viên', color: '#22d39a' },
};
const RAW_CUSTOMERS = [
  [
    'Nguyễn Văn An',
...
export const CUSTOMERS = RAW_CUSTOMERS.map((r, i) => {
  ...
  return {
    ...
    phone,
    role,
    roleLabel: RM[role].label,
    roleColor: RM[role].color,
    roleBg: stBgOf(RM[role].color),
    init: initials(name),
    orders: ord,
    spent,
...
export const NAV_GROUPS = [
  ...
  },
  {
    title: 'Bán hàng',
    items: [
      ['orders', 'Đơn hàng', 'bi-receipt', '12'],
      ['products', 'Sản phẩm', 'bi-box-seam'],
      ['categories', 'Danh mục', 'bi-tags'],
    ],
  },
...
export const CAT_SERIES = [
  {
    ...
    name: 'Laptop',
    color: '#00e5ff',
    data: [320, 360, 410, 380, 450, 520, 490, 560, 610],
  },
  {
    key: 'pc',
    name: 'PC bàn',
    color: '#a855f7',
    data: [240, 280, 300, 330, 360, 410, 390, 440, 480],
  },
  {
    key: 'linhkien',
    name: 'Linh kiện',
    color: '#22d39a',
    data: [160, 180, 200, 210, 240, 280, 260, 300, 330],
  },
  {
    key: 'manhinh',
    name: 'Màn hình',
    color: '#ffb43b',
    data: [90, 110, 120, 130, 150, 165, 158, 180, 200],
  },
  {
    key: 'ngoaivi',
    name: 'Ngoại vi',
    color: '#7aa2ff',
    data: [45, 52, 60, 58, 70, 88, 80, 95, 110],
  },
  {
    key: 'phukien',
    name: 'Phụ kiện',
    color: '#ff6ec7',
    data: [30, 35, 40, 38, 46, 55, 50, 60, 68],
  },
];
export const CAT_COLORS = {
  laptop: '#00e5ff',
  'pc-may-tinh-ban': '#a855f7',
  'linh-kien': '#22d39a',
  'man-hinh': '#ffb43b',
  'ngoai-vi': '#7aa2ff',
  'phu-kien': '#ff6ec7',
...
export const CAT_EN = {
  laptop: 'LAPTOP',
  'pc-may-tinh-ban': 'DESKTOP PC',
  'linh-kien': 'COMPONENTS',
  'man-hinh': 'MONITORS',
  'ngoai-vi': 'PERIPHERALS',
